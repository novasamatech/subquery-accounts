...
const visitor = CreateCallVisitorBuilder()
  ...
  .on("utility", "asMulti", handleMultisigCall)
  .on("utility", "approveAsMulti", handleMultisigCall)
  .on("utility", "cancelAsMulti", handleMultisigCall)
  .on("utility", "asMultiThreshold1", handleMultisigCall)
